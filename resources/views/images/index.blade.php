...
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
    ...
    <a href="{{ route('images.verify') }}" style="padding: 8px 16px; background: #17a2b8; color: white; text-decoration: none; border-radius: 5px; font-size: 14px;">
...
@if(isset($uploadedImages) && count($uploadedImages) > 0)
    const existingImages = @json($uploadedImages);
